...
public class CircularRingPercentageView extends View {
    ...
    private int[] colors = {0xff3CDF5F, 0xffCDD513, 0xffff4639};
    private int radius;
    private RectF oval;
    ...
    public CircularRingPercentageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        colors[0] = mTypedArray.getColor(R.styleable.CircularRing_circleColor1, 0xff3cdf5f);
        colors[1] = mTypedArray.getColor(R.styleable.CircularRing_circleColor2, 0xffcdd513);
        colors[2] = mTypedArray.getColor(R.styleable.CircularRing_circleColor3, 0xffff4639);
        initView();
        mTypedArray.recycle();
    }
