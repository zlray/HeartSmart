...
import com.xqlh.heartsmart.bean.FolderInfo;
import com.xqlh.heartsmart.bean.MusicInfo;
import com.xqlh.heartsmart.bean.SingerInfo;
...
public class MyMusicUtil {
    ...
    public static List<MusicInfo> getCurPlayList(Context context){
        ...
        int playList = MyMusicUtil.getIntShared(Constants.KEY_LIST);
        ...
        switch (playList){
            ...
            case Constants.LIST_PLAYLIST:
                ...
                break;
            case Constants.LIST_SINGER:
                String singerName = MyMusicUtil.getStringShared(Constants.KEY_LIST_ID);
                if (singerName == null){
                    musicInfoList = dbManager.getAllMusicFromMusicTable();
                }else {
                ...
                break;
            case Constants.LIST_ALBUM:
                String albumName = MyMusicUtil.getStringShared(Constants.KEY_LIST_ID);
                if (albumName == null){
                    musicInfoList = dbManager.getAllMusicFromMusicTable();
                }else {
                ...
                break;
            case Constants.LIST_FOLDER:
                String folderName = MyMusicUtil.getStringShared(Constants.KEY_LIST_ID);
                if (folderName == null){
                    musicInfoList = dbManager.getAllMusicFromMusicTable();
                }else {
    ...
    public static void setShared(String key, int value){
        SharedPreferences pref = ContextUtils.getContext().getSharedPreferences("music",ContextUtils.getContext().MODE_PRIVATE);
    ...
    public static int getIntShared(String key) {
        SharedPreferences pref = ContextUtils.getContext().getSharedPreferences("music", ContextUtils.getContext().MODE_PRIVATE);
        int value;
        if (key.equals(Constants.KEY_CURRENT)){
...
//    }
    ...
    public static void setBingShared(String value){
        SharedPreferences pref = ContextUtils.getContext().getSharedPreferences("bing_pic",ContextUtils.getContext().MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
