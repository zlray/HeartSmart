...
import com.xqlh.heartsmart.widget.PlayingPopWindow;
...
public class PlayBarFragment extends Fragment {
    ...
    public static final String ACTION_UPDATE_UI_PlayBar = "com.xqlh.heartsmart.ui.mine.ui.PlayBarFragment:action_update_ui_broad_cast";
...
//      设置Popupwindow显示位置（从底部弹出）
    ...
    class HomeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            duration = intent.getIntExtra(Constants.KEY_DURATION, 100);
            switch (status) {
                case Constants.STATUS_STOP:
                    playIv.setSelected(false);
