    ...
    private void init() {
        ...
        adapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onDeleteMenuClick(View swipeView, int position) {
                ...
                //从列表移除
                dbManager.removeMusic(musicInfo.getId(), Constants.ACTIVITY_LOCAL);
                if (curId == musicId) {
                    //移除的是当前播放的音乐
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            holder.contentLl.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (type.equals(SINGER_TYPE)) {
                        MyMusicUtil.setShared(Constants.KEY_LIST, Constants.LIST_SINGER);
                        MyMusicUtil.setShared(Constants.KEY_LIST_ID, title);
                    } else if (type.equals(ALBUM_TYPE)) {
                        MyMusicUtil.setShared(Constants.KEY_LIST, Constants.LIST_ALBUM);
                        MyMusicUtil.setShared(Constants.KEY_LIST_ID, title);
                    } else if (type.equals(FOLDER_TYPE)) {
                        MyMusicUtil.setShared(Constants.KEY_LIST, Constants.LIST_FOLDER);
                        MyMusicUtil.setShared(Constants.KEY_LIST_ID, getIntent().getStringExtra(KEY_PATH));
                    }
