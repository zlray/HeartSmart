...
import com.xqlh.heartsmart.ui.fragment.adapter.ClassifyDetailAdapter;
import com.xqlh.heartsmart.ui.fragment.adapter.ItemHeaderDecoration;
import com.xqlh.heartsmart.utils.Utils;
import com.xqlh.heartsmart.widget.FlexibleLayout;
...
public class SortDetailFragment extends Fragment implements CheckListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_sort_detail, container, false);
    ...
    public void initView() {
        ...
        mManager = new GridLayoutManager(Utils.getContext(), 3);
        ...
        mAdapter = new ClassifyDetailAdapter(Utils.getContext(), mDatas, new RvListener() {
            @Override
        ...
        mDecoration = new ItemHeaderDecoration(Utils.getContext(), mDatas);
