...
public class SingleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerViewAdapter.setOnItemClickListener(new RecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onContentClick(int position) {
                MyMusicUtil.setShared(Constants.KEY_LIST,Constants.LIST_ALLMUSIC);
            }
        });
    ...
    public void showPopFormBottom(MusicInfo musicInfo) {
        MusicPopMenuWindow menuPopupWindow = new MusicPopMenuWindow(getActivity(),musicInfo,view,Constants.ACTIVITY_LOCAL);
